...
BUBBLE_SORT_INDICES PROC
    ...
    ; Inicializar array_BS con Ìndices secuenciales [0,1,2,...,contador-1]
    mov si, 0
    mov ax, 0
INICIALIZAR_INDICES:
    mov array_BS[si], ax
    ...
    ; Bubble sort para ordenar Ìndices
...
EXTERNO_LOOP:
    ...
    mov si, 0                  ; Õndice para array_BS
    
    ; Calcular lÌmite para loop interno (contador-1)
    mov al, contador
    mov ah, 0
    mov cx, ax
    dec cx
...
INTERNO_LOOP:
    ; Obtener Ìndices actual y siguiente
...
SWAP_INDICES:
    ; Intercambiar Ìndices en array_BS
    mov ax, array_BS[si]
